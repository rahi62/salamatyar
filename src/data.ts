...
export const doctors: Doctor[] = [
  ...
  { id: 'dr4', name: 'دکتر مریم حسینی', departmentId: 'd2', experience: '۵ سال تجربه', bio: 'دندانپزشک زیبایی و ترمیمی', avatarUrl: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?q=80&w=200&auto=format&fit=crop', education: 'آکادمی دندانپزشکی زیبایی', rating: 4.7, reviews: [] },
